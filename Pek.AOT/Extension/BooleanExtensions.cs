...
public static class BooleanExtensions
{
    ...
    /// <param name="value">值</param>
    /// <returns></returns>
    public static String ToYesNoString(this Boolean value)
    {
        return value ? "Yes" : "No";
    }
    ...
    /// <param name="value">值</param>
    /// <returns></returns>
    public static Int32 ToBinaryTypeNumber(this Boolean value)
    {
        return value ? 1 : 0;
    }
    ...
    /// <param name="value">值</param>
    /// <returns></returns>
    public static String ToChineseString(this Boolean value)
    {
    ...
    /// <returns></returns>
    public static String ToChineseString(this Boolean value, String trueStr, String falseStr)
    {
