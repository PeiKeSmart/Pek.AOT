...
/// <summary>
/// 日期时间(<see cref="DateTime"/>/<see cref="DateTimeOffset"/>) 扩展
/// </summary>
public static class DateTimeSysExtensions
{
    ...
    public static DateTime SetDateTime(this DateTime date, Int32 hours, Int32 minutes, Int32 seconds) =>
    ...
    /// <param name="minutes">分</param>
    /// <param name="seconds">秒</param>
    public static DateTimeOffset SetDateTime(this DateTimeOffset date, Int32 hours, Int32 minutes, Int32 seconds) =>
        date.SetDateTime(new TimeSpan(hours, minutes, seconds));
