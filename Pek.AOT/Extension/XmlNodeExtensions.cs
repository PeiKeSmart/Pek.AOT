...
public static class XmlNodeExtensions
{
    ...
    /// <param name="name">属性名</param>
    /// <param name="defaultValue">>默认值。如果没有匹配属性存在</param>
    /// <remarks>AOT 兼容说明：上游 Pek.Common 使用 Conv.CTo&lt;T&gt; 进行类型转换，AOT 版本替换为 BCL Convert.ChangeType</remarks>
    ...
    /// <remarks>AOT 兼容说明：上游 Pek.Common 使用 value.SafeString()，AOT 版本替换为 value?.ToString()</remarks>
    public static void SetAttribute(this XmlNode node, String name, Object value) => SetAttribute(node, name, value?.ToString() ?? String.Empty);
