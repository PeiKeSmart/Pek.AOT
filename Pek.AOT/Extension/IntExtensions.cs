...
public static class IntExtensions
{
    ...
    /// <returns>bool</returns>
    public static Boolean InRange(this Int32 value, Int32 minValue, Int32 maxValue)
    {
    ...
    {
        return (Int32)value.AsLong().InRange(minValue, maxValue, defaultValue);
    }
    ...
    public static String ToOrdinal(this Int32 i)
    {
    ...
    /// <returns>返回的字符串包含序号标记毗邻的数字表示</returns>
    public static String ToOrdinal(this Int32 i, String format)
    {
    ...
    public static Int64 AsLong(this Int32 i)
    {
        return i;
    }
    ...
    /// <returns>bool</returns>
    public static Boolean IsIndexInArray(this Int32 index, Array array)
    {
