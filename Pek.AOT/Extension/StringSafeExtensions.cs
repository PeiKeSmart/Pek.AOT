...
public static class StringSafeExtensions
{
    ...
    /// <returns>安全的Html字符串</returns>
    public static String ToHtmlSafe(this String value, Boolean all)
    {
    ...
    /// <returns>安全的Html字符串</returns>
    public static String ToHtmlSafe(this String value, Boolean all, Boolean replace)
    {
        if (value.IsEmpty())
        {
            return String.Empty;
