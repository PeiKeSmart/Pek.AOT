...
/// <summary>集合（ICollection&lt;T&gt;）扩展。AOT 安全版</summary>
public static class CollectionExtensions
{
    #region AddIfNotContains(添加项。如果未包含，则添加)

    /// <summary>添加项。如果未包含，则添加</summary>
    ...
    /// <summary>添加项集合。如果未包含，则添加</summary>
    /// <typeparam name="T">对象类型</typeparam>
    /// <param name="source">集合</param>
    ...
    /// <summary>添加批量项</summary>
    /// <typeparam name="T">类型</typeparam>
    /// <param name="collection">集合</param>
    /// <param name="enumerable">元素集合</param>
    public static void AddRange<T>(this ICollection<T> collection, IEnumerable<T> enumerable)
    {
        if (collection == null) throw new ArgumentNullException(nameof(collection), $@"源{typeof(T).Name}集合对象不可为空！");
        if (enumerable == null) throw new ArgumentNullException(nameof(enumerable), $@"要添加的{typeof(T).Name}集合项不可为空！");
    ...
    public static void ReplaceItems<TItem, TNewItem>(this ICollection<TItem> collection, IEnumerable<TNewItem> newItems, Func<TNewItem, TItem> createItemAction)
    {
