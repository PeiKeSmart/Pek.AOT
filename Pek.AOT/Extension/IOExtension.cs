...
public static class IOExtension
{
    ...
    /// <returns></returns>
    public static void Write([NotNull] this Stream @this, [NotNull] Byte[] byteArray) => @this.Write(byteArray, 0, byteArray.Length);
    ...
    /// <param name="byteArray">要写入的字节数组</param>
    /// <returns></returns>
    public static Task WriteAsync([NotNull] this Stream @this, [NotNull] Byte[] byteArray) => @this.WriteAsync(byteArray, 0, byteArray.Length);
    ...
    {
        await @this.WriteAsync(await stream.ToByteArrayAsync().ConfigureAwait(false)).ConfigureAwait(false);
        return @this;
    }
