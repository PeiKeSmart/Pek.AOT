...
public class PowerStatus
{
    ...
    /// <summary>报告的主电池电源的完全充电寿命</summary>
    ...
    /// <summary>电池剩余电量</summary>
    public Single BatteryLifePercent
    {
        get
        {
            UpdateSystemPowerStatus();
            var value = _systemPowerStatus.BatteryLifePercent / 100f;
            return value > 1f ? 1f : value;
        }
    }

    /// <summary>电池剩余使用时间</summary>
