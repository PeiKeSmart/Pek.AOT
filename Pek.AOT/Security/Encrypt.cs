...
public static partial class Encrypt
{
    ...
    private static String RsaSign(String value, String key, Encoding encoding, RSAType type)
    {
        ...
        var signBytes = type == RSAType.RSA ? RSAHelper.SignSha1(data, key) : RSAHelper.SignSha256(data, key);
    ...
    public static Boolean RsaVerify(String value, String publicKey, String sign) => RsaVerify(value, publicKey, sign, Encoding.UTF8);
    ...
    /// <param name="sign">签名</param>
    /// <param name="encoding">字符编码</param>
    public static Boolean RsaVerify(String value, String publicKey, String sign, Encoding encoding) => RsaVerify(value, publicKey, sign, encoding, RSAType.RSA);
    ...
    /// <param name="publicKey">公钥</param>
    /// <param name="sign">签名</param>
    public static Boolean Rsa2Verify(String value, String publicKey, String sign) => Rsa2Verify(value, publicKey, sign, Encoding.UTF8);
    ...
    /// <param name="sign">签名</param>
    /// <param name="encoding">字符编码</param>
    public static Boolean Rsa2Verify(String value, String publicKey, String sign, Encoding encoding) => RsaVerify(value, publicKey, sign, encoding, RSAType.RSA2);
    ...
    /// <param name="encoding">字符编码</param>
    /// <param name="type">RSA算法类型</param>
    private static Boolean RsaVerify(String value, String publicKey, String sign, Encoding encoding, RSAType type)
    {
        if (String.IsNullOrWhiteSpace(value))
            return false;
        ...
        return type == RSAType.RSA ? RSAHelper.VerifySha1(data, publicKey, signBytes) : RSAHelper.VerifySha256(data, publicKey, signBytes);
    }
