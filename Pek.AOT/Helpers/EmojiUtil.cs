...
public class EmojiUtil
{
    ...
    /// <summary>判断字符串中是否包含 Emoji 表情符号</summary>
    ...
    /// <summary>删除字符串中的 Emoji 表情符号</summary>
    ...
    /// <summary>将字符串中的 Emoji 表情符号转换为对应的 Unicode 码点</summary>
    ...
    /// <summary>将字符串中的 Emoji 表情符号转换为对应的 HTML 实体编码</summary>
    /// <param name="text">要转换的字符串</param>
    /// <returns>转换后的字符串</returns>
