...
/// <summary>32位64位整数解压缩</summary>
public class CompresTo
{
    /// <summary>Int64转为32进制编码字符串</summary>
    /// <param name="xx"></param>
    /// <returns></returns>
    public static String IntToi32(Int64 xx)
    {
        ...
        while (xx >= 1)
        {
            var index = Convert.ToInt16(xx - xx / 32 * 32);
    ...
    /// <summary>32进制编码字符串转为Int64</summary>
    /// <param name="xx"></param>
    /// <returns></returns>
    ...
    /// <summary>Int64转为64进制编码字符串</summary>
    /// <param name="xx"></param>
    /// <returns></returns>
    ...
    /// <summary>64进制编码字符串转为Int64</summary>
    /// <param name="xx"></param>
    /// <returns></returns>
    ...
    /// <summary>编码表</summary>
    public static Dictionary<Int32, String> Base64Code { get; } = new()
    {
