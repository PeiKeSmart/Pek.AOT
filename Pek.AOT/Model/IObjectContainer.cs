...
public interface IObjectContainer
{
    ...
    IObjectContainer Register([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type serviceType, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type? implementationType, Object? instance);
    ...
    /// <param name="item">服务映射对象</param>
    /// <returns>是否成功添加，已存在时返回 false</returns>
    ...
    Object? GetService([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type serviceType);
    ...
    [Obsolete("=>GetService")]
    [EditorBrowsable(EditorBrowsableState.Never)]
    Object? Resolve([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type serviceType, IServiceProvider? serviceProvider = null);
    #endregion
}
