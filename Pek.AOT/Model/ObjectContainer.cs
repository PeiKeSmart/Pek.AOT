...
public class ObjectContainer : IObjectContainer
{
    ...
    public virtual IObjectContainer Register([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type serviceType, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type? implementationType, Object? instance)
    {
    ...
    [EditorBrowsable(EditorBrowsableState.Never)]
    public virtual Object? GetService([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type serviceType)
    {
        if (serviceType == null) throw new ArgumentNullException(nameof(serviceType));
    ...
    /// <returns>服务实例，未找到时返回 null</returns>
    [EditorBrowsable(EditorBrowsableState.Never)]
    public virtual Object? Resolve([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type serviceType, IServiceProvider? serviceProvider = null)
    {
        if (serviceType == null) throw new ArgumentNullException(nameof(serviceType));
    ...
    internal static Object? CreateInstance([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type type, IServiceProvider provider, Func<IServiceProvider, Object>? factory, Boolean throwOnError)
    {
...
public class ServiceDescriptor : IObject
{
    ...
    /// <param name="serviceType">服务类型</param>
    public ServiceDescriptor([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type serviceType) => ServiceType = serviceType;

    /// <summary>实例化服务描述符</summary>
    /// <param name="serviceType">服务类型</param>
    /// <param name="implementationType">实现类型</param>
    public ServiceDescriptor([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type serviceType, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type? implementationType)
    {
    ...
    /// <param name="implementationType">实现类型</param>
    /// <param name="instance">服务实例</param>
    public ServiceDescriptor([DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type serviceType, [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicConstructors)] Type? implementationType, Object? instance)
    {
        ServiceType = serviceType;
        ImplementationType = implementationType;
        Instance = instance;
