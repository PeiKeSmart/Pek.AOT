...
/// <summary>文件操作辅助类 - 信息（AOT安全版）</summary>
/// <remarks>GetContentType 方法依赖 Pek.Mime，待 Mime 模块迁移后补充</remarks>
public static partial class FileUtil
{
    #region GetExtension(获取文件扩展名)

    /// <summary>获取文件扩展名。例如：a.txt => txt</summary>
    ...
    /// <summary>将字节数组转换为16进制表示的字符串</summary>
