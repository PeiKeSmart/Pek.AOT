...
/// <summary>文件操作辅助类 - 转换（AOT安全）</summary>
public static partial class FileUtil
{
    #region ToString(转换成字符串)

    /// <summary>字节数组转换成字符串</summary>
