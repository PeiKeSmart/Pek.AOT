...
public class NetUri
{
    ...
    public IPEndPoint EndPoint
    {
        get
        {
            ...
            if ((ep.Address == null || IPAddress.Any.Equals(ep.Address) || IPAddress.IPv6Any.Equals(ep.Address)) && !Host.IsNullOrEmpty()) ep.Address = ParseAddress(Host)?.FirstOrDefault() ?? IPAddress.Any;
