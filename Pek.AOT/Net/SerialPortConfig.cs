...
public class SerialPortConfig : Config<SerialPortConfig, SerialPortConfigJsonContext>
{
    private String _webEncoding = Encoding.UTF8.WebName;
    ...
    [JsonIgnore]
    [XmlIgnore]
    public Encoding Encoding => System.Text.Encoding.GetEncoding(_webEncoding);
    ...
    {
        get => _webEncoding;
        set => _webEncoding = String.IsNullOrWhiteSpace(value) ? System.Text.Encoding.UTF8.WebName : value;
    }
...
/// <summary>SerialPortConfig 的 AOT 序列化上下文</summary>
[JsonSerializable(typeof(Parity))]
[JsonSerializable(typeof(StopBits))]
[JsonSerializable(typeof(SerialPortConfig))]
public partial class SerialPortConfigJsonContext : JsonSerializerContext
{
}