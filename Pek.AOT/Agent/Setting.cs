...
[DisplayName("服务设置")]
[Config("Agent.config")]
public class Setting : Config<Setting, AgentSettingJsonContext>
{
    /// <summary>服务名</summary>
    [Description("服务名")]
    ...
    /// <summary>最大句柄数。超过最大占用时，整个服务进程将会重启，以释放资源。默认10000个</summary>
...
/// <summary>Agent.Setting 的 AOT 序列化上下文</summary>
[JsonSerializable(typeof(Setting))]
public partial class AgentSettingJsonContext : JsonSerializerContext
{
}