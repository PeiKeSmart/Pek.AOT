...
public class CalculateExpressionParser
{
    ...
    /// <summary>初始化一个<see cref="CalculateExpressionParser"/>类型的实例</summary>
    /// <param name="expressionStr">表达式字符串</param>
...
{
    /// <summary>计算符号</summary>
    public CalculationSymbol Symbol;

    /// <summary>值</summary>
    public Double Value;

    /// <summary>初始化一个<see cref="CalculateNode"/>类型的实例</summary>
