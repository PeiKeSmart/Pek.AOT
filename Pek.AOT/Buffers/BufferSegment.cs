...
internal sealed class BufferSegment : ReadOnlySequenceSegment<Byte>
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static Int64 GetLength(BufferSegment startSegment, Int32 startIndex, BufferSegment endSegment, Int32 endIndex) =>
        endSegment.RunningIndex + (UInt32)endIndex - (startSegment.RunningIndex + (UInt32)startIndex);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    internal static Int64 GetLength(Int64 startPosition, BufferSegment endSegment, Int32 endIndex) =>
        endSegment.RunningIndex + (UInt32)endIndex - startPosition;
}