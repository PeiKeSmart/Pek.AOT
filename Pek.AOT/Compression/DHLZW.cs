...
/// <summary>海凌科物联网数据压缩算法（LZW变体）</summary>
public class DHLZW
{
    /// <summary>压缩</summary>
    ...
    /// <exception cref="ArgumentException">压缩数据无效</exception>
    public static String Decompress(List<Int32> compressed, Int32 key)
    {
        ...
        var result = new StringBuilder(compressed.Count * 2);
        result.Append(w);
    ...
    /// <summary>位压缩</summary>
    /// <param name="compressed">压缩后的整数列表</param>
    ...
    /// <summary>位解压缩</summary>
    /// <param name="compressed">压缩的字节数组</param>
    ...
    /// <summary>取文本的前三个最高频字符的ASCII码之和作为密钥</summary>
