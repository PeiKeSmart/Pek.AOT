...
{
    /// <summary>业务或系统自定义错误码。0 表示未指定。</summary>
    public Int32 ErrorCode { get; }

    /// <summary>初始化Exception类的新实例</summary>
    public DHException() : this(0) { }

    /// <summary>使用错误码初始化Exception类的新实例</summary>
    ...
    /// <summary>使用指定的错误消息初始化Exception类的新实例</summary>
    /// <param name="message">描述错误的消息</param>
    public DHException(String message)
        : this(0, message) { }

    /// <summary>使用指定的错误码与错误消息初始化Exception类的新实例</summary>
    /// <param name="errorCode">自定义错误码</param>
    /// <param name="message">描述错误的消息</param>
    ...
    /// <summary>使用错误码和格式化消息初始化</summary>
    /// <param name="errorCode">自定义错误码</param>
    /// <param name="messageFormat">异常消息格式</param>
    /// <param name="args">异常消息参数</param>
    ...
    /// <summary>使用指定的错误消息和对引起该异常的内部异常的引用来初始化Exception类的新实例</summary>
    ...
    /// <summary>使用错误码、错误消息和内部异常初始化</summary>
    /// <param name="errorCode">自定义错误码</param>
